...
task manipulator() {
	while(on) {
		...
		if(vexRT(Btn8D) && !chicken) { // This was supposed to make picking up chickens much easier,
			                             // you face the chicken and hit 8D, but it doesn't work as of right now.
		                               // Still trying :).
			chicken = true;
		}
